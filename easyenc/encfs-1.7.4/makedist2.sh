...
tarArchive=encfs-1.7.4.tgz
mv encfs-1.7.4.tar.gz $tarArchive
...
#mv /usr/src/packages/SRPMS/encfs-1.7.4-@RELEASE@.src.rpm dist
#mv /usr/src/packages/RPMS/i586/encfs-1.7.4-@RELEASE@.i586.rpm dist
